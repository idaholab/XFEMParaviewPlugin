/*=========================================================================
  ...
  Module:    vtkXFEMClipPartialElements.h
...
=========================================================================*/
// .NAME vtkXFEMClipPartialElements - clip partial elements produced by MOOSE xfem module
// .SECTION Description
...
//
// .SECTION Thanks
// This filter is based on the vtkClipDataSet filter by Ken Martin, Will Schroeder, and Bill Lorensen

#ifndef __vtkXFEMClipPartialElements_h
#define __vtkXFEMClipPartialElements_h

#include "vtkUnstructuredGridAlgorithm.h"

class vtkIncrementalPointLocator;

class VTK_EXPORT vtkXFEMClipPartialElements : public vtkUnstructuredGridAlgorithm
{
public:
...
private:
  vtkXFEMClipPartialElements(const vtkXFEMClipPartialElements&);  // Not implemented.
  void operator=(const vtkXFEMClipPartialElements&);  // Not implemented.
};
